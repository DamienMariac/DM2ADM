...
On observe sur la figure \ref{fig:HWard} que la différence de coût d'agrégation entre quatres classes et cinq classes n'est pas élevé, on peut donc partitionner en 4 classes.
On calcul les $R^2$ associé à chaque classe :
\begin{figure}[H]
    \centering
    ...
    \label{fig:EvolR2} 
\end{figure}
Par ce graphique, nous pouvons remarquer que les classes potentielles sont 2,3 et 4. Celle ci sont respectivement donnée par un $R^2$ de 0.072, 0.111 et 0.148. Nous choissons de couper en 4 classes.
\\\\
