...
\end{figure}
\\
Le choix de couper en 8 classes signifie que les données ont été divisées en 8 groupes distincts. 
La valeur de \( R^2 = 0.263 \) indique que 26,3 \% de la variance totale des données est expliquée par cette partition en 8 classes.
\end{document}