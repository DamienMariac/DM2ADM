...
\]
avec I le nombre de modalité de X une variable nominale et J le nombre de modalité de Y une variable nominale et $\phi^2$,le coefficient de contingence, il mesure la liaison entre deux variables. 
\\
\\
